...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://limitless-springs-58027.herokuapp.com/',
...
var poseEvents = __webpack_require__(14);
...
var getFormFields = __webpack_require__(4);
var poseApi = __webpack_require__(15);
var poseUi = __webpack_require__(16);

var onCreatePose = function onCreatePose(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  if (data.pose.pose_name === '' && data.pose.muscle_action === '' && data.pose.cues === '') {
    ...
    poseApi.createPose(data).then(poseApi.getPoses).then(poseUi.getPosesSuccess).then(poseUi.createPoseSuccess).catch(poseUi.createPoseError);
  }
};

var onGetPoses = function onGetPoses(event) {
  event.preventDefault();
  poseApi.getPoses().then(poseUi.getPosesSuccess).catch(poseUi.getPosesError);
};

var enableEdits = function enableEdits(event) {
  event.preventDefault();
...
var onUpdatePose = function onUpdatePose(event) {
  event.preventDefault();
  var poseId = event.target.getAttribute('data-id');
  var data = getFormFields(event.target);
  if (data.pose.pose_name === '' && data.pose.muscle_action === '' && data.pose.cues === '') {
    $('#user-messages').html('');
    $('#user-messages').html('<div class="alert alert-warning">\n      <button type="button" class="close" aria-hidden="true" data-dismiss="alert">&times;</button>\n      Please fill out form.\n      </div>');
    ...
    poseApi.updatePose(data, poseId).then(poseApi.getPoses).then(poseUi.getPosesSuccess).then(poseUi.updatePoseSuccess).catch(poseUi.updatePoseError);
  }
};

var onDeletePose = function onDeletePose(event) {
  event.preventDefault();
  var poseId = event.target.getAttribute('data-id');
  poseApi.deletePose(poseId).then(poseApi.getPoses).then(poseUi.getPosesSuccess).then(poseUi.deletePoseSuccess).catch(poseUi.deletePoseError);
};
...
var createPose = function createPose(data) {
  return $.ajax({
    method: 'POST',
...
var updatePose = function updatePose(data, poseId) {
  return $.ajax({
    method: 'PATCH',
...
var deletePose = function deletePose(poseId) {
  return $.ajax({
    method: 'DELETE',
    url: config.apiUrl + '/poses/' + poseId,
    headers: {
...
var store = __webpack_require__(3);
var showPosesTemplate = __webpack_require__(17);

var createPoseSuccess = function createPoseSuccess() {
  $('#user-messages').html('');
  $('#user-messages').html('\n    <div class="alert alert-success alert-dismissable">\n    <button type="button" class="close" aria-hidden="true" data-dismiss="alert">&times;</button>\n    Pose created!\n    </div>\n    ');
  document.getElementById('sign-up-form').reset();
  document.getElementById('sign-in-form').reset();
...
var createPoseError = function createPoseError() {
  $('#user-messages').html('');
  $('.content').html('');
...
var getPosesSuccess = function getPosesSuccess(data) {
  $('#user-messages').html('');
  $('.content').html('');
  // debugger
  var showPosesHtml = showPosesTemplate({ poses: data.poses });
...
var getPosesError = function getPosesError() {
  $('#user-messages').html('');
  $('.content').html('');
  $('#user-messages').html('\n    <div class="alert alert-warning">\n    <button type="button" class="close" aria-hidden="true" data-dismiss="alert">&times;</button>\n    Error loading poses.\n    </div>');
  document.getElementById('sign-up-form').reset();
...
var updatePoseSuccess = function updatePoseSuccess(data, poseId) {
  $('#user-messages').html('');
  $('#user-messages').html('\n    <div class="alert alert-success alert-dismissable">\n    <button type="button" class="close" aria-hidden="true" data-dismiss="alert">&times;</button>\n    Pose updated!</div>\n    ');
  document.getElementById('sign-up-form').reset();
  document.getElementById('sign-in-form').reset();
...
var updatePoseError = function updatePoseError() {
  $('#user-messages').html('');
  $('.content').html('');
  $('#user-messages').html('\n    <div class="alert alert-warning">\n    <button type="button" class="close" aria-hidden="true" data-dismiss="alert">&times;</button>\n    Error updating pose.\n    </div>');
  document.getElementById('sign-up-form').reset();
...
var deletePoseSuccess = function deletePoseSuccess() {
  $('#user-messages').html('');
  $('#user-messages').html('\n    <div class="alert alert-success alert-dismissable">\n    <button type="button" class="close" aria-hidden="true" data-dismiss="alert">&times;</button>\n    Pose deleted!</div>\n    ');
  document.getElementById('sign-up-form').reset();
  document.getElementById('sign-in-form').reset();
...
var deletePoseError = function deletePoseError() {
  $('#user-messages').html('');
  $('.content').html('');
  $('#user-messages').html('\n    <div class="alert alert-warning">\n    <button type="button" class="close" aria-hidden="true" data-dismiss="alert">&times;</button>\n    Error deleting pose.\n    </div>');
  document.getElementById('sign-up-form').reset();
...
module.exports = {
  createPoseSuccess: createPoseSuccess,
  createPoseError: createPoseError,
  getPosesSuccess: getPosesSuccess,
  getPosesError: getPosesError,
  updatePoseSuccess: updatePoseSuccess,
  updatePoseError: updatePoseError,
  deletePoseSuccess: deletePoseSuccess,
  deletePoseError: deletePoseError
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n  <div id=\""
    ...
    + "\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n    <form class=\"save-pose\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n      <h2>Pose: "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.pose_name : stack1), depth0))
    + "</h2>\n      <input name=\"pose[pose_name]\" class=\"hidden editable\" type=\"text\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.pose_name : stack1), depth0))
    + "\">\n      <ul class=\"list-edit\">\n        <li class=\"uneditable\">Muscle action: <span class=\"current-val\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.muscle_action : stack1), depth0))
    + "</span>\n        <input name=\"pose[muscle_action]\" class=\"hidden editable\" type=\"text\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.muscle_action : stack1), depth0))
    + "\"></li>\n        <li class=\"uneditable\">Cues: <span class=\"current-val\">"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.cues : stack1), depth0))
    + "</span>\n        <input name=\"pose[cues]\" class=\"hidden editable\" type=\"text\" value=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.cues : stack1), depth0))
    + "\"></li>\n      </ul>\n      <button class=\"update-pose btn btn-default\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Edit pose</button>\n      <button class=\"save-button hidden btn btn-default\" type=\"submit\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Save edits</button>\n      <button class=\"delete-pose btn btn-default\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Delete pose</button>\n    </form>\n  </div>\n\n";
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
    var stack1;

  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.poses : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
